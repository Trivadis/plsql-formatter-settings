...
create or replace function mgrname(p_empno in emp.empno%type) return emp.ename%type is
...
begin
   -- Select
   select depno as department_number, dname as departmen_name, loc as department_location
     from dept, emp
...
create or replace procedure insertdept(p_deptno in out dept.deptno%type,
